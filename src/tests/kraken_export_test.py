    ...
    def test_staking(self):
        ...
        for test_case in [
            [
                ...
                '{"amount": "1.556e-05", "fee": "5.56e-06", "coin": "SOL"}',
            ],
            [
                1,
                "2022-04-11 15:44:17",
                const.EARN_OPERATION,
                const.KRAKEN_EARN_DESCRIPTION,
                '{"amount": "1.1e-07", "fee": "0.0", "coin": "BTC"}',
            ],
            [
                2,
                "2022-04-13 03:17:03",
                const.EARN_OPERATION,
                const.KRAKEN_EARN_DESCRIPTION,
                '{"amount": "0.00123985", "fee": "0.0", "coin": "KSM"}',
            ],
            [
                3,
                "2022-04-13 07:47:57",
                const.EARN_OPERATION,
                const.KRAKEN_EARN_DESCRIPTION,
                '{"amount": "0.01132135", "fee": "0.0", "coin": "DOT"}',
            ],
            [
                4,
                "2022-05-01 07:01:51",
                const.EARN_OPERATION,
                const.KRAKEN_EARN_DESCRIPTION,
                '{"amount": "5.7522e-05", "fee": "0.0", "coin": "ETH2"}',
            ],
        ]:
